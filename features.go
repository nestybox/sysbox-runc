...
import (
	...
	"github.com/nestybox/sysbox-runc/libcontainer/capabilities"
	"github.com/nestybox/sysbox-runc/libcontainer/configs"
	"github.com/nestybox/sysbox-runc/libcontainer/seccomp"
	"github.com/nestybox/sysbox-runc/libcontainer/specconv"
	runcfeatures "github.com/nestybox/sysbox-runc/types/features"
	...
	Action: func(context *cli.Context) error {
		...
		feat := features.Features{
			...
			Annotations: map[string]string{
				...
				runcfeatures.AnnotationRuncCommit:            commitId,
