...
// checkSupportedDistro checks if the host has a Linux distro supported by Sysvisor
func checkSupportedDistro() error {
	...
	return fmt.Errorf("linux distro %s %s is not supported by sysvisor; supported distros are %v",
