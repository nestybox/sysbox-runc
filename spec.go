...
When starting a container through sysbox-runc, sysbox-runc needs
root privileges. If not already running as root, you can use sudo to
give sysbox-runc root privilege. For example: "sudo sysbox-runc
start syscont1" will give runc root privilege to start the system
container on your host.

sysbox-runc does not currently support running without root
privileges (i.e., rootless).
`,
	Flags: []cli.Flag{
		cli.StringFlag{
			Name:  "bundle, b",
